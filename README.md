About google-maps-routing-feedstock
===================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/google-maps-routing-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/google-maps-routing-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add google-maps-routing
# for installing globally
pixi global install google-maps-routing
```
...
It is possible to list all of the versions of `google-maps-routing` available on your platform:
...
```
pixi search google-maps-routing --channel conda-forge
```
